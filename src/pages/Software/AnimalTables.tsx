...
export const AnimalRoles: React.FC = () => {
    ...
    const generateTableRow = useCallback((role: AnimalRole) => {
        ...
        return (
            <tr key={string} className={role.role && 'primary' || role.element && 'element' || role.detail && 'detail'}>
    ...
    return (
        <table className="animal">
            ...
            <tbody>
                {animalRoles.map(generateTableRow)}
            </tbody>
        </table>
    )
}
...
export const AnimalFeatures: React.FC = () => {
    ...
    const generateTableRow = useCallback((feature: AnimalFeature) => {
        ...
        return (
            <tr key={string} className={feature.feature && 'primary' || feature.element && 'element' || feature.detail && 'detail'}>
                <td className="main">{string}</td>
    ...
    return (
        <table className="animal">
            ...
            <tbody>
                {animalsFeatures.map(generateTableRow)}
            </tbody>
        </table>
    )
}